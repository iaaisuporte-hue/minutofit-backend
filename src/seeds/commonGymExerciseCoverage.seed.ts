...
export const COMMON_GYM_EXERCISE_ALIASES: Record<string, string[]> = {
  ...
  'Tríceps Testa (Skull Crusher)': ['Tríceps testa com barra'],
  'Tríceps Francês com Haltere': ['Tríceps francês com halter'],
  'Extensão de Tríceps com Haltere Unilateral': ['Tríceps francês unilateral'],
  'Tríceps Corda (Pushdown)': ['Tríceps corda na polia'],
  ...
  'Dip em Barras Paralelas': ['Paralelas'],
...
export const COMMON_GYM_EXERCISES_SEED: ExerciseSeed[] = [
  ...
  makeExercise({
    ...
    secondaryMuscles: [],
    equipment: 'cabo',
    aliases: ['Extensão de tríceps acima da cabeça na polia'],
    movementPattern: 'empurrar',
  }),
  makeExercise({
