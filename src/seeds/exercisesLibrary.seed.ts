...
export const EXERCISES_SEED: ExerciseSeed[] = [
  ...
  },
  {
    ...
    secondaryMuscles: ['Elevador da escápula'],
    equipment: 'cabo',
    tags: ['academia', 'trapézio', 'ombro', 'polia'],
    instructions: [
      'Posicione-se de frente para a polia baixa e segure os cabos com as mãos ao lado do corpo.',
      'Eleve os ombros em direção às orelhas mantendo os braços estendidos.',
      'Desça lentamente retornando à posição inicial.',
    ],
  ...
  },
  {
    ...
    secondaryMuscles: ['Elevador da escápula'],
    equipment: 'barra',
    tags: ['academia', 'trapézio', 'ombro', 'força'],
    instructions: [
      ...
      'Mantenha no topo por um segundo e desça controladamente.',
    ],
